...
const StepperLayout: React.FC<StepperLayoutProps> = ({ activeStep, children }) => {
  ...
  return (
    <div className={css['container']}>
      <div className={`hidden md:flex ${css['vertical-stepper']}`}>
        ...
        <div className={css['vertical-stepper__footer']}>
          <span className={css['vertical-stepper__footer__text']}>© Socious Global Inc. 2024</span>
          <div className="flex gap-2">
            <Icon name="mail-01" fontSize={16} className="text-Gray-light-mode-600" />
            <span className={css['vertical-stepper__footer__text']}>help@socious.io</span>
          </div>
        </div>
      </div>
